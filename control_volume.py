...
object = {
    "name": "control_volume",
    "description": f"Control system volume. Required format: For setting volume use {{\"set\": number}} where number is 0-100, or for adjusting volume use {{\"adjust\": number}} where number is -100 to +100.",
    "parameters": {
        "type": "object",
        "properties": {
            "set": {
